...
# Project: vivek Eyewear Shop

[**Live version** of the site can be found here](https://vivek-eyewear.vercel.app//)

Eyewear is a mock-up of an e-commerce website that sells eyewear products. The website offers a range of eyewear products, including prescription glasses and trendy sunglasses & frames. This project was created as a practice on using React Router and testing UI elements using the React Testing Library and Vitest.
