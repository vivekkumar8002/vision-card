...
export const allProductsCategoryData = {
  documentTitle: 'COLLECTION | Shop all products - vivek Eyewear Store',
  banner: {
    title: 'All Products',
    description:
    ...
    img: '/unsplash/frame-12.webp',
    imgCompressed: '/unsplash/frame-12.webp',
...
export const eyeglassesCategoryData = {
  documentTitle: 'OPTICAL | Trendy Frames & Styles - vivek Eyewear Store',
  banner: {
    title: 'Optical Shop',
    description:
    ...
    img: '/unsplash/frame-7.webp',
    imgCompressed: '/unsplash/frame-7.webp',
...
export const sunglassesCategoryData = {
  documentTitle: 'SUNGLASSES | Trendy Frames & Styles - vivek Eyewear Store',
  banner: {
    title: 'Sunnies Store',
    description:
    ...
    img: '/unsplash/hero-view.webp',
    imgCompressed: '/unsplash/hero-view.webp',
