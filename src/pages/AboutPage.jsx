...
function AboutPage() {
  useEffect(() => {
    document.title = 'The vivek Experience | vivek Eyewear Online Store';
  }, []);
    ...
    <main className="story">
      <section className="story-header">
        ...
        <p className="story-header__text">
          ...
          Elevate your eyewear game with frames.
        </p>
      </section>
      ...
      <section className="story-main">
        <ImageWrapper className="story-main__panel panel-1">
          <ProgressiveImage
            ...
            placeholder={`${BLOB_URL}/unsplash/frame-12.webp`}
          >
            {(src, loading) => (
              <img
                src={src}
        ...
        <div className="story-main__panel panel-2 about-us">
          ...
          <p className="story-main__text">
            was born of a simple mission - to create high-quality,
        ...
        <div className="story-main__panel panel-3 eyeglasses">
          ...
          <p className="story-main__text">
            At vivek, we believe that everyone should have access to stylish
        ...
        <ImageWrapper className="story-main__panel panel-4">
          <ProgressiveImage
            src={`${BLOB_URL}/unsplash/frame-3.webp`}
            placeholder={`${BLOB_URL}/unsplash/frame-3.webp`}
          >
            {(src, loading) => (
              <img
                src={src}
        ...
        <ImageWrapper className="story-main__panel panel-5">
          <ProgressiveImage
            src={`${BLOB_URL}/unsplash/yohji-yamamoto-7029-1.jpg`}
            placeholder={`${BLOB_URL}/unsplash/yohji-yamamoto-7029-1.jpg`}
          >
            {(src, loading) => (
              <img
                src={src}
      ...
      <section className="story-eyecare">
        ...
        <ImageWrapper className="story-eyecare__img-wrapper">
          <ProgressiveImage
            src={`${BLOB_URL}/unsplash/store-50.webp`}
            placeholder={`${BLOB_URL}/unsplash/store-50.webp`}
          >
            {(src, loading) => (
              <img
                src={src}
